use feg_case_studies::matern_functional_convergence::{
...
fn parse_args(args: impl Iterator<Item = String>) -> Result<FunctionalConvergenceConfig, String> {
    let mut config = FunctionalConvergenceConfig::default();
...
fn print_usage() {
    println!("Usage: cargo run -p feg-case-studies --release --example matern_functional_convergence -- [options]");
    println!();
    println!("Options:");
